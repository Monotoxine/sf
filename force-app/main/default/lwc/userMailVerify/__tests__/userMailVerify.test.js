...
import UserMailVerify from "c/userMailVerify";
...
jest.mock(
  "@salesforce/apex/UserMailVerifyController.getSettings",
  () => ({ default: jest.fn() }),
  { virtual: true }
);
jest.mock(
  "@salesforce/apex/UserMailVerifyController.getUnverifiedUsers",
  () => ({ default: jest.fn() }),
  { virtual: true }
);
jest.mock(
  "@salesforce/apex/UserMailVerifyController.launchVerification",
  () => ({ default: jest.fn() }),
  { virtual: true }
);
jest.mock(
  "@salesforce/apex/UserMailVerifyController.launchPasswordReset",
  () => ({ default: jest.fn() }),
  { virtual: true }
);
...
function createComponent() {
  const element = createElement("c-user-mail-verify", { is: UserMailVerify });
